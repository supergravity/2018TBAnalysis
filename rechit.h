...
// Thu Jul 12 14:10:29 2018 by ROOT version 6.10/08
// from TTree hits/HGC rechits
// found on file: ./root_data/data/v8/ntuple_245.root
//////////////////////////////////////////////////////////
...
#ifdef rechit_cxx
rechit::rechit(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("./root_data/data/v8/ntuple_245.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("./root_data/data/v8/ntuple_245.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("./root_data/data/v8/ntuple_245.root:/rechitntupler");
...
Int_t rechit::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t rechit::LoadTree(Long64_t entry)
{
...
void rechit::Show(Long64_t entry)
{
...
Int_t rechit::Cut(Long64_t entry)
{
